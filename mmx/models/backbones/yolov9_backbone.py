...
class DetYOLOv9Backbone(BaseBackbone):
    arch_settings = {
        ...
        't': [
            ...
            ['mmx.AConv', 'mmx.RepNCSPELAN4', 64, 64, 64, 3,],  # out_indices=2, stage_idx=1
        ...
        's1': [
            ...
            ['mmx.AConv', 'mmx.RepNCSPELAN4', 256, 256, 256, 1],
        ],
        'm1': [
            ['ConvModule', 'mmx.RepNCSPELAN4', 64, 128, 128, 1],
            ['mmx.AConv', 'mmx.RepNCSPELAN4', 240, 240, 240, 1],
            ['mmx.AConv', 'mmx.RepNCSPELAN4', 360, 360, 360, 1],
            ['mmx.AConv', 'mmx.RepNCSPELAN4', 480, 480, 480, 1],
        ],
        'm2': [
            ['ConvModule', 'mmx.RepNCSPELAN4', 64, 128, 128, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 240, 240, 240, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 360, 360, 360, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 480, 480, 480, 1],
        ],
        'c1': [
            ['ConvModule', 'mmx.RepNCSPELAN4', 128, 256, 128, 1],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 256, 512, 256, 1],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 512, 512, 512, 1],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 512, 512, 512, 1],
        ],
        'c2': [
            ['ConvModule', 'mmx.RepNCSPELAN4', 128, 256, 128, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 256, 512, 256, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 512, 512, 512, 1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 512, 512, 512, 1],
        ],
        'e1': [
            ['ConvModule', 'mmx.RepNCSPELAN4', 128, 256, 128, 2],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 256, 512, 256, 2],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 512, 1024, 512, 2],
            ['mmx.ADown', 'mmx.RepNCSPELAN4', 1024, 1024, 512, 2],
        ],
        'e2': [
            ['mmx.CBFuse', 'ConvModule', 64, 128, -1, -1],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 128, 256, 128, 2],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 256, 512, 256, 2],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 512, 1024, 512, 2],
            ['mmx.CBFuse', 'mmx.RepNCSPELAN4', 1024, 1024, 512, 2],
        ],
    }
    ...
    def build_stage_layer(self, stage_idx: int, setting: list) -> list:
        ...
        if block_type == 'mmx.ELAN1':
            block_cfg['mid_channels'] = mid_channels
        elif block_type == 'mmx.RepNCSPELAN4':
            block_cfg['mid_channels'] = mid_channels
    ...
    def _build_downsample_layer(self, downsample_type: str, in_channel: int,
        ...
        assert downsample_type in (
            ...
            'mmx.AConv',
            'mmx.ADown',
        ), "downsample_type must be in ['ConvModule', 'mmx.AConv', 'mmx.ADown']"
...
@MODELS.register_module()
class DetCB_YOLOv9Backbone(BaseModule):
    ...
    def __init__(
            ...
            down_module_cfg: dict = dict(type='mmx.AConv', ),
            **kwargs,
    ):
        super().__init__()
    ...
    def _init_backbones(self, archs, pred_out_indices, reduce_indices,
                        **kwargs):
        self.backbone1 = DetYOLOv9Backbone(
        ...
        if (self.training
            ...
            self.backbone2 = DetYOLOv9Backbone(
...
@MODELS.register_module()
class DetCB_YOLOv9Backbone2(DetCB_YOLOv9Backbone):
